...
row.names(dat_2) <- c("Tempo 1", "Tempo 2", "Tempo 3", "Tempo 4") #nomeia linhas
...
server <- function(input, output) {
  ...
  renderBarChart(div_id = "test_4", theme = "infographic", direction = "vertical", grid_left = "10%", data = dat_2, axis.x.name = "Fungicidas para Soja", axis.y.name = "Protocolos Fungicidas")
